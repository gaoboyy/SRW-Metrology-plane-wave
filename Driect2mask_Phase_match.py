...
def propogation(op2):
    ...
    if(_int_type >= 0): 
        ...
        if(True):
            ...
            srwl_uti_save_intens_ascii(wp_arI, wfr2.mesh,"Direct2mask_Wfr_phase(match 20.6m).dat", 0, ['Photon Energy', 'Horizontal Position', 'Vertical Position', ''], _arUnits=['eV', 'm', 'm', sValUnitName])
        return wp_arI           
