...
def main():
    ...
    global xRatio
    global yRatio
    xRatio = pixel_size * pixel_num / (srwl_bl.wfr.mesh.xFin - srwl_bl.wfr.mesh.xStart)
    yRatio = pixel_size * pixel_num / (srwl_bl.wfr.mesh.yFin - srwl_bl.wfr.mesh.yStart)
